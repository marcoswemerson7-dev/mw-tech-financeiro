    ...
    <>
      <style>{`
        @media (min-width: 1024px) {
          ...
          body.mw-sidebar-collapsed div[class*="lg:pl-[254px]"] {
      ...
      <button
        ...
        className="fixed top-[92px] z-50 hidden size-8 place-items-center rounded-full border border-slate-200 bg-white text-slate-600 shadow-[0_6px_18px_rgba(7,24,45,.18)] transition-all hover:bg-slate-50 lg:grid"
