...
export type TeamAccess={id:string;nome:string;email:string;cpf?:string;cargo:string;status:string;modulos:string[];created_at:string;updated_at:string;auth_user_id?:string;login_criado?:boolean};
