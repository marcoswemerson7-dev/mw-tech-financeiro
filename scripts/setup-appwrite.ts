...
const tables = [
  ...
  { id: "monitoring_incidents", name: "Incidentes de monitoramento", permissions: [], columns: [s("incident_key",255,true),s("system",20,true),s("system_label",120,true),s("severity",20,true),s("source",30,true),s("title",255,true),s("message",32768),s("action_url",2048),b("active",true),dt("first_seen_at",true),dt("last_seen_at",true),{key:"occurrences",type:"integer",required:false,default:1},b("acknowledged",false),dt("acknowledged_at"),s("acknowledged_by",64),dt("resolved_at"),dt("updated_at",true)], indexes:[{key:"incident_key_unique",type:"unique",attributes:["incident_key"]},{key:"incident_system",type:"key",attributes:["system"]},{key:"incident_active",type:"key",attributes:["active"]},{key:"incident_last_seen",type:"key",attributes:["last_seen_at"]}] },
